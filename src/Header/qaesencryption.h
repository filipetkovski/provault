...
public:
    ...
    QByteArray encryptData(const QString &inputStr, const QString &key);
    QString decryptData(const QByteArray &encryptedData, const QString &key);
    QByteArray encryptKey(const QString &key);
    QString decryptKey(const QByteArray &encryptedKey);
    QByteArray customHash();
    QString customIv() const;
